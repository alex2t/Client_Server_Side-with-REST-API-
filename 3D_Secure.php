...
<script src="https://www.paypal.com/sdk/js?components=hosted-fields,buttons&client-id=<?php echo $clientId; ?>&merchant-id=N94HPK83QS2S2&locale=fr_FR&debug=true&currency=EUR&intent=capture" data-client-token="<?php echo $client_token; ?>">
...
<form id="my-sample-form">
  <label id ="card" for="card-number">Card Number</label>
  <div id="card-number"></div> 
  <label id="date" for ="expiration-date">Expiration Date</label>
  <div id="expiration-date"></div>
  <label id="check" for="cvv">CVV</label>
  <div id="cvv"></div>
